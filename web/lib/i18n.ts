export const translations = {
  en: {
    ...
    "Visualize knowledge clusters and their relationships":
      "Visualize knowledge clusters and their relationships",
    ...
    Repulsion: "Repulsion",
    Centering: "Centering",
    "No clusters to display": "No clusters to display",
    ID: "ID",
    Degree: "Degree",
  ...
  zh: {
    ...
    Repulsion: "斥力",
    Centering: "向心力",
    "No clusters to display": "没有可显示的簇",
    ID: "ID",
    Degree: "连接度",
    Confidence: "置信度",
    Hotness: "热度",
